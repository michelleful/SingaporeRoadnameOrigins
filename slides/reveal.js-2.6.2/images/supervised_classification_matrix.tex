...
\foreach \x in  {0,16.6,35,80,90} % edit here for the vertical lines
...
\draw[shift={(69,0)},color=gray] (0pt,20pt) -- (0pt,-20pt);

\foreach \x in {0,16.6,35,80,90,100} % edit here for the numbers
...
\draw[shift={(69,0)},color=gray] (0pt,0pt) -- (0pt,-3pt) node[below] {69};
\node at (16,-5) {Random};
\node at (35,3) {Most frequent};
\node at (80,-5) {Where we are};
